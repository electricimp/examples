...
typedef enum
{
  LIS3DH_X_LOW       = 0b00000001, //0x01,
  LIS3DH_X_HIGH      = 0b00000010, //0x02,
  LIS3DH_Y_LOW       = 0b00000100, //0x04,
  LIS3DH_Y_HIGH      = 0b00001000, //0x08,
  LIS3DH_Z_LOW       = 0b00010000, //0x10,
  LIS3DH_Z_HIGH      = 0b00100000, //0x20,
  LIS3DH_SIX_D       = 0b01000000, //0x40,
  LIS3DH_AOI         = 0b10000000  //0x80
} lis3dh_intOpts_t;
...
class Adafruit_LIS3DH : public Adafruit_Sensor {
 public:
  ...
  void setInertialInt(bool state, float thresh, uint8_t timelimit, uint8_t options);
 ...
 private:
  ...
  uint8_t twosComp(uint8_t value, uint8_t mask);
